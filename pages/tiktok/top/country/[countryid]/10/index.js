...
export async function getServerSideProps(ctx) {
	...
	const redis_key = country + 'tiktok10'
    ...
    try {
		if (cache) {
			...
			const res = await fetch(`${api_url}/v1/tops/tiktok/country/${country}/10`, {
				headers: {
...
const TiktokTopCountry10 = ({ user_country }) => {
    const user_data = user_country;
    const country_full_name = user_data[0].country_full_name;
    const description = "These are the Top 10 TikTok accounts in "+ country_full_name +" with the most followers right now. Track followers, views and likes on major social media platforms with Insiflow.";
  	const title = "Top 10 Most Followed TikTok accounts in "+ country_full_name +" in 2023 | Insiflow";
    ...
    return (
        <div>
            ...
            <div className='container md:flex mx-auto pt-8'>
                ...
                <h2 className='pb-2'>A list of the most popular 10 Followed {country_full_name} TikTok Users right now. These are the most popular Users sorted by TikTok followers.</h2>
                    <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                            <div className="overflow-hidden">
                                <h3 className='text-lg pb-2 font-bold'>Top 10 TikTok Influencers in 2023 sorted by followers in {country_full_name}</h3>
...
export default TiktokTopCountry10;